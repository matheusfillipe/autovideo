...
#
#           Usage:  noise  output.wav [noise_type=brown] [minutes=59]  [band-pass freq center=1786]  [wave]
...
output=${1:-'noise.wav'}
#  ^ default output file name is "noise.wav"
echo "Output file: $output"

noise=${2:-'brown'}
#     ^your choice: 'white', 'pink', 'brown', 'tpdf'. Default: 'brown'
...
sox -c 2 -n "$output" synth  $len  ${noise}noise  \
     band -n $center 499               \
